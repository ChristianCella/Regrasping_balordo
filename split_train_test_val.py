...
IMAGE_FOLDER = os.path.join('/Project/Regrasping_balordo/data/labelled_beckers/train', 'images')
LABEL_FOLDER = os.path.join('/Project/Regrasping_balordo/data/labelled_beckers/train', 'labels')
