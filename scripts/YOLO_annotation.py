s# This script allows users to annotate images with bounding boxes for object detection tasks.
...
LABEL_FOLDER = os.path.join(current_directory, 'data', 'labels')  # Folder to store YOLO annotations
